...
const MagicRainbowButton = ({children}) => {
    ...
    const ElToReturn = () => {
        return (<>
                ...
                <br/>
                {hellState.active && (<select value={selectedMusic} onChange={handleMusicSelection}>
                ...
                {selectedMusic === "lo-fi" && (<ReactPlayer
                        ...
                        height={0}
                    />)}
                {selectedMusic === "nyan-cat" && (<ReactPlayer
                        ...
                        height={0}
                    />)}
                {selectedMusic === "rain" && (<ReactPlayer
                        ...
                        height={0}
                    />)}
                {selectedMusic === "synth" && (<ReactPlayer
